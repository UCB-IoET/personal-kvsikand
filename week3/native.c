...
const LUA_REG_TYPE contrib_native_map[] =
{
    ...
    { LSTRKEY( "CFG_1SAMPLE" ), LNUMVAL(0x00)},
    { LSTRKEY( "CFG_2SAMPLE" ), LNUMVAL(0x02)},
    { LSTRKEY( "CFG_4SAMPLE" ), LNUMVAL(0x04)},
    { LSTRKEY( "CFG_8SAMPLE" ), LNUMVAL(0x06)},
    { LSTRKEY( "CFG_16SAMPLE" ), LNUMVAL(0x08)},
